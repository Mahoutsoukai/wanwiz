package wanwiz.repository;

import wanwiz.KalimaApp;
import wanwiz.config.Constants;
import wanwiz.config.audit.AuditEventConverter;
import wanwiz.domain.PersistentAuditEvent;
...
import static wanwiz.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
